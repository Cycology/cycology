...
//Define root path
#define ROOT_PATH ((char *)"~/Documents/cycology/fuse-3.0.2/example/rootdir/root")
#define STORE_PATH ((char *)"~/Documents/cycology/fuse-3.0.2/example/rootdir/virtualNAND")
